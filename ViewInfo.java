...
public class ViewInfo extends JFrame /*implements ActionListener*/{
    JTextField tffname,tfaddress,tfemail,tfphone,tfeducation,tfBookLanguage,tfTime,tfdob; 
    JButton update,back,edit;
    JComboBox cbBookGenre;
    JLabel lblname,lbllname,lbluname,lblsalary, lbldob, lblphone,lblemail,lbluser;
    ...
    ViewInfo(String username){
        ...
        setLayout(null);
        setTitle("Student Profile - Library");

        JLabel heading=new JLabel("<html><p style='border-bottom: 3px solid rgb(BLACK);'> Student Profile </p></html>");
        ...
        JLabel heading1=new JLabel("Student Information");
        ...
        lblname = new JLabel();
        lblname.setBounds(570,120,150,65);
        ...
        lbllname = new JLabel();
        lbllname.setBounds(990,120,150,65);
        ...
        labeldob.setBounds(850,160,120,65);
        ...
        tfdob.setBounds(990,176,150,30);
        ...
        labeladdress.setBounds(450,200,120,65);
        labeladdress.setFont(new Font("Arial",Font.BOLD,18));
        add(labeladdress);

        tfaddress =new JTextField();
        tfaddress.setBounds(570,220,200,30);
        ...
        labeleducation.setBounds(450,240,120,65);
        labeleducation.setFont(new Font("Arial",Font.BOLD,18));
        add(labeleducation);

        tfeducation=new JTextField();
        tfeducation.setBounds(570,260,200,30);
        ...
        labelemail.setBounds(450,350,170,65);
        labelemail.setFont(new Font("Arial",Font.BOLD,18));
        add(labelemail);

        lblemail=new JLabel();
        lblemail.setBounds(640,350,220,30);
        lblemail.setFont(font);
        add(lblemail);

        JLabel labelphone=new JLabel("Phone number:");
        labelphone.setBounds(450,390,170,65);
        labelphone.setFont(new Font("Arial",Font.BOLD,18));
        add(labelphone);

        lblphone=new JLabel();
        lblphone.setBounds(640,390,180,30);
        ...
        */
        ...
        heading3.setBounds(450,450,200,50);
        ...
        labelBookGenre.setBounds(450,490,150,65);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("./images/Student.png"));
        ...
        /*JLabel labelstudentid=new JLabel("Staff Id:");
        ...
        lbluser = new JLabel();//display username 
        lbluser.setBounds(90,300,210,45);
        lbluser.setFont(new Font("MONOSPACED",Font.BOLD,22));
        ...
        if(ae.getSource() ==edit){
            ...
            try{
                 ...
                 while(rs.next()) {
                    ...
                    lblphone.setText(rs.getString("sphone"));
                    lblemail.setText(rs.getString("semail"));
            ...
            if(address.length() != 0 && education.length() >= 3 && bookGenre.length() != 0 && readingTime.length() != 0 && language.length() != 0 && dob.length() !=0){
                    try{
                        Conn conn = new Conn();
                        String query = "update studentdetails set address = '"+address+"' , education = '"+education+"' , bookGenre = '"+bookGenre+"'  , readingTime='"+readingTime+"', language='"+language+"' where username = '"+username+"'";
